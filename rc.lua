...
local function client_menu_toggle_fn()
    ...
    return function ()
        if instance and instance.wibox.visible then
            ...
            instance = awful.menu.client_list({ theme = { width = 250 } })
        end
    end
end
...
myawesomemenu = {
    { "hotkeys", function() hotkeys_popup.show_help(nil, awful.screen.focused()) end, icon_dir .. 'scalable/apps/gnome-settings-keybindings.svg' },
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ 'α', 'β', 'γ', 'δ' }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "Tab",
        ...
        {description = "focus forward", group = "client"}),
...
awful.rules.rules = {
    ...
    { rule_any = {type = { "normal", "dialog" } },
      except_any = { class = { "Google-chrome" } },
